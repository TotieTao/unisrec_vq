...
class UniSRec(SASRec):
    ...
    def pretrain_all(self, interaction):
        loss_h = self.v1_pretrain(interaction, "item_id", "item_id_list", "item_length", "item_emb_list", "pos_item_emb")
        # loss_s = self.v1_pretrain(interaction, "item_id_short", "item_id_list_short", "item_length_short", "item_emb_list_short", "pos_item_emb_short")
        # loss_l = self.v1_pretrain(interaction, "item_id_long", "item_id_list_long", "item_length_long", "item_emb_list_long", "pos_item_emb_long")
        # print(loss_h, loss_s)
        # return loss_h + (loss_s + loss_l) * 0.5
        return loss_h
